...
public class GaleriActivity extends AppCompatActivity {
    ...
    private void inisialisasiView() {
        ...
        if( this.jenisHewan == "Anjing" ) {
            txJudul.setText("Berbagai Macam Koleksi Foto Ronaldo");
        } else  {
            txJudul.setText("Berbagai Macam Koleksi Foto Messi");
        }
    }
